...
#       python ./download-all-2018-08-30_12-55-10.py
#    Download all files in a Metalink/CSV: (downloaded from ASF Vertex)
#       python ./download-all-2018-08-30_12-55-10.py /path/to/downloads.metalink localmetalink.metalink localcsv.csv
...
class bulk_downloader:
    def __init__(self):
        ...
        # self.files = [ "http://host.com/product1.zip",
        #               "http://host.com/product2.zip" ]
        self.files = list
        ...
        if len(sys.argv) > 0:
            ...
            if len(input_files) > 0:
                if len(download_files) > 0:
                    print (
                    " > Processing {0} downloads from {1} input files. ".format(len(download_files), len(input_files)))
